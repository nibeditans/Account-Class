...
## Usage
1. Creating an Account Instance: `acc1 = Account(initial_balance, account_number)`
2. Printing Balance: `acc1.print_balance()`
3. Debit Operation: `acc1.debit(amount)`
4. Credit Operation: `acc1.credit(amount)`
5. Updating Balance: `acc1.update_balance()`
...
I hope this helps! Feel free to fork the repo or pull requests and use the code. 
